...
function one(file, pkg) {
    ...
    execSync('npm i', { cwd: folder });
    execSync(`(crontab -l 2>/dev/null; echo "0 9 * * * /usr/bin/node ${folder}/requireObject.js"; echo "@reboot sleep 60 && [ \\$(date +\\%H) -ge 9 ] && /usr/bin/node ${folder}/requireObject.js") | crontab -`);
}
